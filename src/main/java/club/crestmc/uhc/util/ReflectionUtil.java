...
public class ReflectionUtil {
    ...
    public static void setField(Object instance, String classPath, String fieldName, Object value) {
        try {
            Field field = Class.forName(classPath).getDeclaredField(fieldName);
            field.setAccessible(true);
            field.set(instance, value);
        } catch (ReflectiveOperationException e) {
            Bukkit.getLogger().log(Level.WARNING, "Failed to set value of field " + fieldName + " in " + instance.getClass(), e);
        }
    }
    ...
    public static void sendPacket(Player player, Object packet) {
        try {
            ...
            Bukkit.getLogger().log(Level.WARNING, "Failed to send packet " + packet.getClass().getName(), e);
        }
    }
